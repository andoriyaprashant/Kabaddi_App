...
class _LiveScoreState extends State<LiveScore> {
  ...
  void initState() {
    ...
    //   String? id = YoutubePlayer.convertUrlToId(data?["videoUrl"]);
    //   if (id != null) {
    //     print("id is not null " + id);
    //     _controller = YoutubePlayerController(
    //       initialVideoId: id,
    //       flags: YoutubePlayerFlags(
    //           autoPlay: false, mute: false, isLive: data?["isLive"]),
    //     );
    //   } else {
    //     _controller = YoutubePlayerController(initialVideoId: 'LxyWuPV_MRs');
    //   }
